...
/// \file  SplineHelperTest.h
/// \brief Definition of SplineHelperTest class
///
/// \author  Sergey Gorbunov <sergey.gorbunov@cern.ch>

#ifndef ALICEO2_GPUCOMMON_TPCFASTTRANSFORMATION_SPLINEHELPERTEST_H
#define ALICEO2_GPUCOMMON_TPCFASTTRANSFORMATION_SPLINEHELPERTEST_H
...
///
/// The SplineHelperTest class is to initialize Spline* objects
///
...
class SplineHelperTest
{
 public:
  ...
  SplineHelperTest(const SplineHelperTest&) CON_DELETE;

  /// Assignment operator: disabled
  SplineHelperTest& operator=(const SplineHelperTest&) CON_DELETE;

  /// Destructor
  ~SplineHelperTest() CON_DEFAULT;
...
template <typename DataT>
template <bool isConsistentT>
int SplineHelperTest<DataT>::setSpline(
