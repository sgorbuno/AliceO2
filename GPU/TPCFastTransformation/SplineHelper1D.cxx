...
std::unique_ptr<float[]> SplineHelper1D::constructParametersClassical(int Ndim, std::function<void(float, float[])> F, float uMin, float uMax)
{
  // Create 1D->Ndim spline in a classical way:
...
std::unique_ptr<float[]> SplineHelper1D::constructParameters(int Ndim, std::function<void(float, float[])> F, float uMin, float uMax)
{
