  ...
  : public Spline2DSpec<DataT, YdimT, Spline1DUtil::getSpec(YdimT)>
{
 ...
 public:
  ...
  Spline2D() CON_DELETE;
  Spline2D(const Spline2DSpec&) CON_DELETE;
#endif

  /// cast to the one-parameter-template class
  operator Spline2D<DataT>&() { return *((Spline2D<DataT>*)this); }

  /// const cast
  operator const Spline2D<DataT>&() const { return *((const Spline2D<DataT>*)this); }
