...
class SplineHelper
{
 public:
  ...
  void approximateFunction(Spline<DataT>& spline,
  ...
  int setSpline(const Spline<DataT>& spline, const int nAxiliaryPoints[/* Xdim */]);
...
int SplineHelper<DataT>::setSpline(
  const Spline<DataT>& spline, const int nAxiliaryPoints[/* Xdim */])
{
